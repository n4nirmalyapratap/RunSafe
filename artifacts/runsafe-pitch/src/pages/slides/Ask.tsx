    ...
    >
      ...
      <div style={{ position: "relative", zIndex: 10, margin: "8vh 8vw", width: "calc(100vw - 16vw)", height: "calc(100vh - 16vh)", backgroundColor: "rgba(255, 255, 255, 0.4)", backdropFilter: "blur(1vw)", WebkitBackdropFilter: "blur(1vw)", borderRadius: "2vw", display: "flex", flexDirection: "column", justifyContent: "space-between", boxSizing: "border-box", padding: "4vh 4vw" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          ...
          <div style={{ backgroundColor: "#c8b6ff", padding: "0.8vh 1.5vw", borderRadius: "2vw", fontSize: "1vw", fontWeight: 700, color: "#2d3748" }}>The Ask</div>
        </div>

        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", flex: 1, textAlign: "center" }}>
          <div style={{ display: "inline-block", padding: "0.5vh 1.5vw", backgroundColor: "#2d3748", borderRadius: "2vw", fontSize: "1.2vw", fontWeight: 700, color: "#ffffff", marginBottom: "3vh", textTransform: "uppercase", letterSpacing: "0.1vw" }}>Series Seed</div>
          <h2 style={{ fontSize: "6.5vw", fontWeight: 800, color: "#1a202c", lineHeight: 1.05, margin: "0 0 2vh 0", letterSpacing: "-0.15vw", maxWidth: "70vw", textWrap: "balance" }}>
            Raising $2.4M
          </h2>
          <p style={{ fontSize: "1.8vw", color: "#4a5568", lineHeight: 1.4, margin: "0 0 5vh 0", maxWidth: "55vw" }}>
            18-month runway to ship Stripe billing, mobile, and the state-specific compliance library.
          </p>
          <div style={{ display: "flex", gap: "2vw" }}>
            <div style={{ backgroundColor: "#ffbca6", color: "#1a202c", fontSize: "1.4vw", fontWeight: 700, padding: "2vh 3vw", borderRadius: "3vw", boxShadow: "0 1vw 2vw rgba(255, 188, 166, 0.4)" }}>
              45% Engineering
            </div>
            <div style={{ backgroundColor: "#aed9e0", color: "#1a202c", fontSize: "1.4vw", fontWeight: 700, padding: "2vh 3vw", borderRadius: "3vw" }}>
              35% GTM
            </div>
            <div style={{ backgroundColor: "#c8b6ff", color: "#1a202c", fontSize: "1.4vw", fontWeight: 700, padding: "2vh 3vw", borderRadius: "3vw" }}>
              20% Compliance content
            </div>
          </div>
        </div>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", paddingTop: "2vh", borderTop: "0.2vw solid rgba(45, 55, 72, 0.1)" }}>
          <div style={{ fontSize: "1.2vw", fontWeight: 500, color: "#718096" }}>hello@runsafe.app</div>
          <div style={{ fontSize: "1.2vw", fontWeight: 700, color: "#2d3748" }}>17</div>
        </div>
      </div>
    </div>
  );
